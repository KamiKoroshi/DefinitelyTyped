// Type definitions for steam-user 4.12.5
// Project: https://github.com/DoctorMcKay/node-steam-user
// Definitions by: KamiKoroshi <https://github.com/KamiKoroshi>
...
declare class SteamChatRoomClient {
    ...
    //#region Events
    public on(event: 'friendMessage', listener: (message: IncomingFriendMessage) => void): this;
    public on(event: 'friendMessageEcho', listener: (message: IncomingFriendMessage) => void): this;
    public on(event: 'friendTyping', listener: (message: IncomingFriendMessage) => void): this;
    public on(event: 'friendTypingEcho', listener: (message: IncomingFriendMessage) => void): this;
    public on(event: 'friendLeftConversation', listener: (message: IncomingFriendMessage) => void): this;
    public on(event: 'friendLeftConversationEcho', listener: (message: IncomingFriendMessage) => void): this;
    public on(event: 'chatMessage', listener: (message: IncomingFriendMessage) => void): this;
    public on(
    ...
    getClanChatGroupInfo(
        clanSteamID: SteamIDResolvable,
        callback: (
            err: Error | null,
            response: {
                chat_group_summary: ChatRoomGroupSummary;
            },
        ) => void,
    ): Promise<{
        chat_group_summary: ChatRoomGroupSummary;
     ...
     */
    getActiveFriendMessageSessions(): any;
...
declare class SteamUser {
    ...
    blockUser(steamID: SteamIDResolvable, callback?: (err: Error | null) => void): any;
    cancelAuthTicket(appid: number, callback: () => void): any;
    cancelTradeRequest(steamID: SteamIDResolvable): void;
    changeTradeURL(callback: (err: Error | null, response: { token: string; url: string }) => void): any;
    ...
    checkQuickInviteLinkValidity(link: any, callback: any): any;

    createChatRoom(convertUserID: any, inviteUserID: any, callback: any): any;

    createFriendsGroup(groupName: any, callback: any): any;

    createQuickInviteLink(options: any, callback: any): any;

    deleteFriendsGroup(groupID: any, callback: any): any;

    downloadChunk(appID: any, depotID: any, chunkSha1: any, contentServer: any, callback: any): any;

    downloadFile(appID: any, depotID: any, fileManifest: any, outputFilePath: any, callback: any): any;
    ...
    getAppRichPresenceLocalization(appID: any, language: any, callback: any): any;

    getAssetClassInfo(language: any, appid: any, classes: any, callback: any): any;

    getAuthSecret(callback: any): any;

    getAuthSessionTicket(appid: any, callback: any): any;

    getCDNAuthToken(appID: any, depotID: any, hostname: any, callback: any): any;
    ...
    getManifest(appID: any, depotID: any, manifestID: any, callback: any): any;

    getNicknames(callback: any): any;

    getOwnedApps(excludeSharedLicenses: any): any;

    getOwnedDepots(excludeSharedLicenses: any): any;

    getOwnedPackages(excludeSharedLicenses: any): any;

    getPersonas(steamids: any, callback: any): any;

    getPlayerCount(appid: any, callback: any): any;

    getPrivacySettings(callback: any): any;

    getProductAccessToken(apps: any, packages: any, callback: any): any;

    getProductChanges(sinceChangenumber: any, callback: any): any;

    getProductInfo(apps: any, packages: any, inclTokens: any, callback: any, requestType: any): any;

    getPublishedFileDetails(ids: any, callback: any): any;

    getQuickInviteLinkSteamID(link: any): any;

    getRawManifest(appID: any, depotID: any, manifestID: any, callback: any): any;
    ...
    listQuickInviteLinks(callback: any): any;
    ...
    ownsDepot(depotid: any, excludeSharedLicenses: any): any;

    ownsPackage(packageid: any, excludeSharedLicenses: any): any;

    redeemKey(key: any, callback: any): any;

    redeemQuickInviteLink(link: any, callback: any): any;

    relog(): void;

    removeFriend(steamID: any): void;

    removeFriendFromGroup(groupID: any, userSteamID: any, callback: any): any;
    ...
    revokeQuickInviteLink(linkOrToken: any, callback: any): any;

    sendToGC(appid: any, msgType: any, protoBufHeader: any, payload: any, callback: any): void;
...
declare namespace SteamUser {
    ...
    function parseAppTicket(ticket: any, allowInvalidSignature: any): any;
    function parseEncryptedAppTicket(ticket: any, encryptionKey: any): any;
}
